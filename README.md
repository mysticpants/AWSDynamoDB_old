...
### Example
Retrieves data from the database that was sent in the BatchWriteItem Example
...
Parameter      	 	    	|       Type						  	      | Required | Default |  Description
--------------------------- | ------------------------------------------  | -------- | ------  | -------------
Key							| Table 									  | Yes		 | N/A 	   | The primary key of the item to be updated. See: [here](http://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_AttributeValue.html)
TableName					| String									  | Yes		 | N/A 	   |  The name of the table containing the item to update
AttributesUpdates			| Table 									  | No		 | null    | See : [here](http://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributeUpdates.html)
